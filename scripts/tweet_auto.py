...
・「知らないと確実に損する話」
・「今すぐやらないと後悔する理由」
・「投資しない人より投資する人の方が〇〇な件」

【スタイルの方向性】
・物議を醸す意見・多数派に反する主張も臆せず言い切る
・「なんで誰も教えてくれなかったんだろ」という気づき系
・「投資してる人とそうでない人の格差」を煽る
・銀行・定期預金への疑問提起
・緊急性・危機感を煽る（「今すぐ」「手遅れになる前に」）
・絵文字は😤🔥💥😱🤯😅💸を感情に合わせて使う"""
    else:
...
【スタイルの方向性】
・断言・言い切りで弱腰表現は禁止（「〜かもしれません」はNG）
・危機感・緊急性を前面に出す
・具体的な数字で現実の厳しさを突きつける
・「知っている人 vs 知らない人」の格差を強調
・絵文字は📊💥🔥⚠️💸😱を効果的に使う
・ランキング（①②③）や「〇〇選」形式は保存率が高い"""
